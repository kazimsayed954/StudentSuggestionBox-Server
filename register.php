<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($row) {
            ...
            $query = "INSERT INTO users ( `unique_id`, `name`, `email`,`rollno`, `encrypted_password`, `otp`, `created_at` ) 
            VALUES ( :uuid, :name, :email, :rollno, :encrypted_password, :otp, NOW() )";
